...
?>
<html>
<head><Link  type = "text/css" href = "../Styles/content.css"  rel = "stylesheet" />
 <Link  type = "text/css" href = "../Styles/displayposts.css"  rel = "stylesheet" /></head>
<body>
 <?php
             if(isset($_GET['del'])){
		                  if($_GET['del'] == "suc")
						   {
							   ...
							   <a href='science.php'>Refresh</a></font></center>
							 "; 
						   }elseif($_GET['del'] == "fai")
						   {
               ...
               if(isset($_GET['pageno'])){
					   ...
					   if(isset($_GET['info'])){
						   ...
						   }elseif($_GET['info'] == "succ")
						   {
							   ...
							   <a href='science.php?pageno=$pag_no'>Refresh</a></font></center>
							 "; 
					  ...
					  ?>
					   ...
					   <div id="Right_rightContent2"><!-- Right_rightContent_Navigation pane-->
					   
					   
							    <form action="computer.php?table_name=scienceposts" method="POST">
								 <?php
