		                  ...
		                  if($_GET['del'] == "suc")
						   {
							   ...
							   <a href='mycomputer.php'>Refresh</a></font></center>
							 "; 
						   }elseif($_GET['del'] == "fai")
						   {
					  ...
					  if(isset($_GET['pageno'])){
					   ...
					   if(isset($_GET['info'])){
		                   if($_GET['info'] == "succ")
						   {
							   ...
							   <a href='mycomputer.php?pageno=$pag_no'>Refresh</a></font></center>
							 "; 
					  ...
					  ?>
					   ...
					   <!-- display posts from here-->
								<div id="postContainer">
								      <text style="Font-size: 20px; font-style: italic; color: #120073; margin:10px; ">My Computer Posts</text>
