		                  ...
		                  if($_GET['del'] == "suc")
						   {
							   ...
							   <a href='arts.php'>Refresh</a></font></center>
							 "; 
						   }elseif($_GET['del'] == "fai")
						   {
                     ...
                     if(isset($_GET['pageno'])){
					   ...
					   if(isset($_GET['info'])){
						   ...
						   }elseif($_GET['info'] == "succ")
						   {
							   ...
							   <a href='arts.php?pageno=$pag_no'>Refresh</a></font></center>
							 "; 
					  ...
					  ?>
					   ...
					   <div id="Right_rightContent4"><!-- Right_rightContent_Navigation pane-->
					   
					   
							    <form action="computer.php?table_name=artsposts" method="POST">
								 <?php
					  ...
					  ?>
								...
								<?php dislayPosts($tableName="artsposts",$Topictable="artstopic",$sec="Arts") ?>
								</div>
						</div>
