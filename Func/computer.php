...
<body>
		                  ...
		                  if($_GET['del'] == "suc")
						   {
							   ...
							   <a href='computer.php'>Refresh</a></font></center>
							 "; 
						   }elseif($_GET['del'] == "fai")
						   {
					  ...
					  if(isset($_GET['pageno'])){
					   ...
					   if(isset($_GET['info'])){
						   ...
						   }elseif($_GET['info'] == "succ")
						   {
							   ...
							   <a href='computer.php?pageno=$pag_no'>Refresh</a></font></center>
							 "; 
					  ...
					  ?>
					   <div id="Right_rightContent"><!-- Right_rightContent_Navigation pane-->
							    ...
							    <form action="computer.php?table_name=computerposts" method="POST">
								 <?php
					  ...
					  ?>
								...
								<?php dislayPosts($tableName="computerposts",$Topictable="computertopic",$sec="Computer Science") ?>
								</div>
